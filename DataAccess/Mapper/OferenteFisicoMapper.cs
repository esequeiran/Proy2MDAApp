...
{
    public class OferenteFisicoMapper : EntityMapper, ISqlStatements, IObjectMapper
    {
        ...
        {
            var operation = new SqlOperation { ProcedureName = "CRE_OFERENTE_FISICO_PR" };

            var c = (OferenteFisico)entity;
            ...
            operation.AddNVarcharParam(DB_COL_TIPO_CEDULA_COMERCIAL, "Fisico");
