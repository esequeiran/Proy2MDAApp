class vRegistrarAdministrador {
    ...
    getValuesForm() {
        const adminData = this.ctrlActions.GetDataForm('frmCreate');
        adminData.TipoIdentificacion = this.obtenerTipoId(parseInt(adminData.TipoIdentificacion));
        adminData.Genero = this.obtenerGeneroId(parseInt(adminData.Genero));
        adminData.PaisNacimiento = this.obtenerPais(parseInt(adminData.PaisNacimiento));
        this.ctrlActions.PostToAPI('Administrador', adminData);
        this.clearForm();
    }
...
document.addEventListener("DOMContentLoaded", function (event) {
    const controller = new vRegistrarAdministrador();
